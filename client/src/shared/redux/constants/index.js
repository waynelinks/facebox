...
export const CLARIFAI_URL = 'CLARIFAI_URL'
...
export const FACEBOX_CLARIFAI_API_CALL = process.env.RAZZLE_CLARIFAI_API_CALL

export const CLARIFAI_API_CALL  = 'CLARIFAI_API_CALL'   
